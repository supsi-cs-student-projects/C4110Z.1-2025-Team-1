                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    _buildHomeButton(
                        ...
                        bottom: groundHeight * 0.02,
                        // In HomePage's _buildHomeButton for 'ACCOUNT'
                        // In HomePage's _buildHomeButton for 'ACCOUNT' (both portrait and landscape)
                        onPressed: () async {
                          ...
                          // Only reload if the AccountPage indicates a successful update
                          if (result == true) {
                            _loadUser();
                          }
                        },
